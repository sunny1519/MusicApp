package com.example.admin.musicapp.youtuberecyclerview.src.main.java.com.susyimes.youtuberecyclerview;
...
public class YoutubeVideoAdapter extends RecyclerView.Adapter<YoutubeVideoAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int position) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.fragment_home, null, false);
