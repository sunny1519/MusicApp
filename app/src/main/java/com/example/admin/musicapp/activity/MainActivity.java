package com.example.admin.musicapp.activity;
...
public class MainActivity extends AppCompatActivity {
    ...
    //API key  AIzaSyDQphPQ04clr5yoFb5oR62uuj04ZjnHfRk
    // urls to load navigation header background image
    // and profile image
    private static final String urlNavHeaderBg = "https://api.androidhive.info/images/nav-menu-header-bg.jpg";
    private static final String urlProfileImg = "http://gonnasolutions.in/images/gonna-solutions.jpg";
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText("FunTunes");
        txtWebsite.setText("www.gonnasolutions.com");
